...
describe('what a rename does to a review row', () => {
  ...
  it('takes the flag with it unless the flag is written again', () => {
    ...
    db.prepare('INSERT INTO songsPendingReview VALUES (?, ?)').run(old.songId, 'All Right Now - Free (Karaoke Version)')
    ...
    db.prepare('INSERT INTO songsPendingReview VALUES (?, ?)').run(fresh.songId, 'All Right Now - Free (Karaoke Version)')
