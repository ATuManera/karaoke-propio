...
import { searchAcquisition, previewAcquisition, clearPreview, acquireResult } from 'routes/Library/modules/acquisition'
 ...
 */
const AcquisitionModal = ({ initialQuery, onClose }: AcquisitionModalProps) => {
  ...
  const handleSearch = (e: React.FormEvent) => {
    e.preventDefault()
    if (query.trim()) dispatch(searchAcquisition(query.trim(), source, karaokeOnly))
  }
  ...
  return (
    <>
      <Modal
        ...
        title={previewingResult ? 'Preview' : 'Search for a song'}
        scrollable
